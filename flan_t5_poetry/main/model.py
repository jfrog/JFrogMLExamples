...
import frogml
import torch
from frogml.sdk.model.adapters.output_adapters.frogml_with_default_fallback import AutodetectOutputAdapter
from frogml.sdk.model.base import BaseModel
from frogml.sdk.model.schema import ExplicitFeature, ModelSchema
from transformers import T5Tokenizer, T5ForConditionalGeneration


# Define the FLANT5Model class inheriting from BaseModel
class FLANT5Model(BaseModel):
    ...
    @frogml.api(output_adapter=AutodetectOutputAdapter())
    def predict(self, df):
